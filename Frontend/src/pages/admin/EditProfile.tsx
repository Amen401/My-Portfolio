  ...
  const handleSaveSection = async (section: string) => {
    ...
    switch (section) {
      case "Core Identity":
        ...
        break;
      case "Narratives":
        endpoint = "/profile/narratives";
        break;
      case "Social Connections":
        endpoint = "/profile/connections";
        break;
      case "Credentials":
        endpoint = "/profile/credentials";
    ...
    try {
      ...
      if (section === "Credentials") setCurrentPassword("");
    } catch (err: any) {
    ...
    <div className="max-w-4xl mx-auto space-y-8 pb-12" id="edit-profile">
      <div className="space-y-1">
        ...
        <p className="text-[10px] text-neutral-500 font-bold uppercase tracking-widest">
          Update global metadata and public credentials independently.
        </p>
      </div>
        ...
        <section className="bg-white dark:bg-neutral-900 p-8 rounded-md border border-neutral-100 dark:border-neutral-800 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="space-y-2">
              <label className="text-[10px] font-bold uppercase text-neutral-400 flex items-center gap-1.5">
        ...
        <section className="bg-white dark:bg-neutral-900 p-8 rounded-md border border-red-100 dark:border-red-900/30 space-y-8 relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
            <div className="space-y-6">
              ...
              <div className="space-y-2">
                <label className="text-[10px] font-bold uppercase text-neutral-400 flex items-center gap-1.5">
                  <Lock className="w-3 h-3" /> New Passcode
                </label>
                <input
                  type="password"
            ...
            <div className="bg-red-50 dark:bg-red-950/20 p-6 rounded-md border border-red-100 dark:border-red-900/40 space-y-4">
              <div className="space-y-1">
                ...
                <p className="text-[9px] text-red-500/70 font-bold uppercase tracking-tight">
                  System requires current secret to commit changes.
                </p>
              </div>
              <input
                type="password"
