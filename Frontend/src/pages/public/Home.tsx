  ...
  if (!profile) {
    return (
      <div className="flex justify-center py-20 text-red-500">
        Failed to load profile. Ensure the backend is running.
      </div>
    );
  }
    ...
    <div className="flex flex-col gap-24 py-12" id="home-page">
      ...
      >
        ...
        <div id="name-section" className="space-y-4">
          ...
          <h1
            className="text-5xl md:text-8xl lg:text-9xl font-black text-neutral-950 dark:text-white tracking-tighter"
            id="profile-name"
          >
            {profile.fullName}
          </h1>
        ...
        <div
          ...
          className="max-w-4xl space-y-8 bg-white dark:bg-neutral-900/60 p-8 md:p-16 rounded-md border border-neutral-100 dark:border-neutral-800"
        >
          ...
          <p
            className="text-2xl md:text-4xl text-neutral-950 dark:text-neutral-100 leading-tight font-black"
              ...
              {[...techLogos, ...techLogos].map((tech, i) => (
                ...
                >
                  <img
                    src={tech.logoUrl}
                    alt={tech.name}
                    className="w-10 h-10 md:w-12 md:h-12 grayscale opacity-40 hover:grayscale-0 hover:opacity-100 transition-all cursor-default"
                  />
            ...
            {techLogos.map((tech) => (
              ...
              >
                <img
                  src={tech.logoUrl}
                  alt={tech.name}
                  className="w-10 h-10 md:w-12 md:h-12 grayscale group-hover:grayscale-0 transition-all"
                />
                <span className="text-[10px] font-bold text-neutral-400 group-hover:text-primary transition-colors uppercase tracking-widest">
                  {tech.name}
                </span>
              </motion.div>
            ))}
      ...
      >
        {[
          ...
          <div
            key={i}
            className="p-8 bg-white dark:bg-neutral-900/50 border border-neutral-100 dark:border-neutral-800 rounded-md flex flex-col items-center justify-center space-y-4 group hover:border-primary/50 transition-all"
          >
            <div
              className={cn(
                "p-3 rounded-md bg-neutral-50 dark:bg-black/40 group-hover:scale-110 transition-transform",
                metric.color,
              )}
            >
            ...
            <div className="text-center">
              <div className="text-2xl md:text-3xl font-black text-neutral-950 dark:text-white">
                {metric.value}
              </div>
