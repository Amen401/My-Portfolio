...
export default function Projects() {
  ...
  return (
    <div className="space-y-8" id="projects-page">
      ...
      >
        <div className="space-y-2">
          ...
          <p className="text-xs text-neutral-500 dark:text-neutral-400">
            A detailed collection of technical challenges and architectural
            solutions.
          </p>
        </div>
      ...
      <div
        className="flex items-center justify-between py-4 border-y border-neutral-100 dark:border-neutral-800"
        id="projects-toolbar"
      >
      ...
      {loading ? (
        ...
        >
          {filteredProjects.map((project) => (
            <ProjectCard key={project._id} project={project} view={viewMode} />
          ))}
        </div>
      ) : (
